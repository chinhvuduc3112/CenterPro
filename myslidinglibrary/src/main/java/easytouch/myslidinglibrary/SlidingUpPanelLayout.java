package easytouch.myslidinglibrary;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private boolean isEnableSlidingPanel = true;
    ...
    public void enableSlidingPanel() {
        isEnableSlidingPanel = true;
    }

    public void disableSlidingPanel() {
        isEnableSlidingPanel = false;
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {

        if (!isEnableSlidingPanel) {
            return false;
        }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mSlideableView != null && mSlideableView != child) { // if main view
            ...
            if (mCoveredFadeColor != 0 && mSlideOffset > 0) {
                ...
                mCoveredFadePaint.setColor(Color.TRANSPARENT);
